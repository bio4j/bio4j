...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.TurnFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.TransmembraneRegionFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.NonConsecutiveResiduesFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.protein.ProteinGoRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.RepeatFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.nodes.ConsortiumNode;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.OnlineInformationCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.protein.ProteinErroneousGeneModelPredictionRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.DevelopmentalStageCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.TopologicalDomainFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.TissueSpecificityCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.nodes.citation.ThesisNode;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.protein.ProteinIsoformRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.FunctionCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.CatalyticActivityCommentRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.CompositionallyBiasedRegionFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.SubunitCommentRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.InductionCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.SiteFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.PropeptideFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.HelixFeatureRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.TransitPeptideFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.CofactorCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.nodes.TaxonNode;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.MetalIonBindingSiteFeatureRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.PolymorphismCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.CalciumBindingRegionFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.DomainFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.citation.book.BookPublisherRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.CautionCommentRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.NucleotidePhosphateBindingRegionFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.MutagenesisSiteFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.DnaBindingRegionFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.ToxicDoseCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.nodes.CommentTypeNode;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.SequenceConflictFeatureRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.BasicCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.protein.ProteinDatasetRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.CoiledCoilRegionFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.PeptideFeatureRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.MassSpectrometryCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.CrossLinkFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.PharmaceuticalCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.RnaEditingCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.DiseaseCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.nodes.ProteinNode;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.StrandFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.SignalPeptideFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.DisulfideBondFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.nodes.citation.UnpublishedObservationNode;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.NonStandardAminoAcidFeatureRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.PostTranslationalModificationCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.GlycosylationSiteFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.nodes.KeywordNode;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.DisruptionPhenotypeCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.RegionOfInterestFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.BioPhysicoChemicalPropertiesCommentRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.NonTerminalResidueFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.BiotechnologyCommentRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.SequenceVariantFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.nodes.FeatureTypeNode;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.BasicFeatureRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.ShortSequenceMotifFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.BindingSiteFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.UnsureResidueFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.LipidMoietyBindingRegionFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.citation.book.BookEditorRel;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.protein.ProteinSubcellularLocationRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.ZincFingerRegionFeatureRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.AllergenCommentRel;
...
import com.era7.bioinfo.bio4j.neo4j.model.relationships.features.ModifiedResidueFeatureRel;
import com.era7.bioinfo.bio4j.neo4j.model.nodes.citation.OnlineJournalNode;
import com.era7.bioinfo.bio4j.neo4j.model.relationships.comment.EnzymeRegulationCommentRel;
