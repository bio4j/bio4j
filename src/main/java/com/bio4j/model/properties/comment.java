...
public interface comment <N extends Node<N,NT>, NT extends Enum<NT> & NodeType<N,NT>> 
  ...
  // static type method
  public static <
    N extends Node<N,NT> & comment<N,NT>, 
    NT extends Enum<NT> & NodeType<N,NT>
  > Type<N,NT> TYPE(NT nodeType) { return new Type<N,NT>(nodeType); }

  // convenience type
  public class Type <N extends Node<N,NT> & comment<N,NT>, NT extends Enum<NT> & NodeType<N,NT>> 
