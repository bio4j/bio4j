...
public interface Definition <N extends Element<N,NT>, NT extends Enum<NT> & ElementType<N,NT>> 
  ...
  // convenience type
  public class Type <N extends Element<N,NT> & Definition<N,NT>, NT extends Enum<NT> & ElementType<N,NT>> 
