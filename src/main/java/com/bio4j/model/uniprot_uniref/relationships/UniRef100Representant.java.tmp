 ...
 */
public interface UniRef100Representant <
		S extends UniRef100Cluster<S, ST>, ST extends UniRefGraph.UniRef100ClusterType<S, ST>,
		R extends UniRef100Representant<S, ST, R, RT, T, TT>, RT extends UniprotUniRefGraph.UniRef100RepresentantType<S, ST, R, RT, T, TT>,
