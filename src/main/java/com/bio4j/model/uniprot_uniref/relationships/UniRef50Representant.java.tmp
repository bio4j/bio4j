 ...
 */
public interface UniRef50Representant <
		S extends UniRef50Cluster<S, ST>, ST extends UniRefGraph.UniRef50ClusterType<S, ST>,
		R extends UniRef50Representant<S, ST, R, RT, T, TT>, RT extends UniprotUniRefGraph.UniRef50RepresentantType<S, ST, R, RT, T, TT>,
