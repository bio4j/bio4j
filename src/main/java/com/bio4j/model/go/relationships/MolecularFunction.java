 ...
 */
public interface MolecularFunction extends GoSubOntology<MolecularFunction, MolecularFunction.Type> {

  public static Type TYPE = Type.molecularFunction;

  @Override public default Type type() { return TYPE; }

  public static enum Type implements GoSubOntology.Type<MolecularFunction, MolecularFunction.Type> {
