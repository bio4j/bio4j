  ...
  > 
{
  ...
  // Vertex types
      ...
      >
    {
      ...
      protected GoSlimsType(RVT raw) { super(raw); }
      ...
      >
    {
      ...
      protected GoTermType(RVT raw) { super(raw); }
      ...
      {
        public id() { super( GoTermType.this.graph().GoTerm() ); }
      ...
      {
        public name() { super( GoTermType.this.graph().GoTerm() ); }
        public Class<String> valueClass() { return String.class; }
      }
      ...
      {
        public definition() { super( GoTermType.this.graph().GoTerm() ); }
        public Class<String> valueClass() { return String.class; }
      }
      ...
      {
        public comment() { super( GoTermType.this.graph().GoTerm() ); }
        public Class<String> valueClass() { return String.class; }
      }
    }
      ...
      >
    {
      ...
      protected SubOntologiesType(RVT raw) { super(raw); }

      @Override 
      public SubOntologiesType value() { return graph().SubOntologies(); }
      @Override 
      public SubOntologies<I,RV,RVT,RE,RET> from(RV vertex) { return new SubOntologies<I,RV,RVT,RE,RET>(vertex,this); }
    }
      ...
      TypedEdge.Type.ManyToMany
    {
      ...
      protected PartOfType(RET raw) { super( GoGraph.this.GoTerm(), raw, GoGraph.this.GoTerm() ); }
      ...
      TypedEdge.Type.ManyToMany
    {
      ...
      protected HasPartOfType(RET raw) { super( GoGraph.this.GoTerm(), raw, GoGraph.this.GoTerm() ); }
      ...
      TypedEdge.Type.ManyToMany
    {
      ...
      protected IsAType(RET raw) { super( GoGraph.this.GoTerm(), raw, GoGraph.this.GoTerm() ); }
      ...
      TypedEdge.Type.ManyToMany
    {
      ...
      protected NegativelyRegulatesType(RET raw) { super( GoGraph.this.GoTerm(), raw, GoGraph.this.GoTerm() ); }

      @Override 
      public NegativelyRegulatesType value() { return graph().NegativelyRegulates(); }
      @Override 
      public NegativelyRegulates<I,RV,RVT,RE,RET> from(RE edge) { return new NegativelyRegulates<I,RV,RVT,RE,RET>(edge, this); }
    }
      ...
      TypedEdge.Type.ManyToMany
    {
      ...
      protected PositivelyRegulatesType(RET raw) { super( GoGraph.this.GoTerm(), raw, GoGraph.this.GoTerm() ); }

      @Override 
      public PositivelyRegulatesType value() { return graph().PositivelyRegulates(); }
      @Override 
      public PositivelyRegulates<I,RV,RVT,RE,RET> from(RE edge) { return new PositivelyRegulates<I,RV,RVT,RE,RET>(edge, this); }
    }
      ...
      TypedEdge.Type.ManyToMany
    {
      ...
      protected RegulatesType(RET raw) { super( GoGraph.this.GoTerm(), raw, GoGraph.this.GoTerm() ); }

      @Override 
      public RegulatesType value() { return graph().Regulates(); }
      @Override 
      public Regulates<I,RV,RVT,RE,RET> from(RE edge) { return new Regulates<I,RV,RVT,RE,RET>(edge, this); }
    }
      ...
      TypedEdge.Type.ManyToOne
    {
      ...
      protected SubOntologyType(RET raw) { super( GoGraph.this.GoTerm(), raw, GoGraph.this.SubOntologies() ); }

      @Override 
      public SubOntologyType value() { return graph().SubOntology(); }
      @Override 
      public SubOntology<I,RV,RVT,RE,RET> from(RE edge) { return new SubOntology<I,RV,RVT,RE,RET>(edge, this); }
    }
    ...
    TypedVertex<V,VT,GoGraph<I,RV,RVT,RE,RET>,I,RV,RVT,RE,RET>
  {
    ...
    @Override public GoGraph<I,RV,RVT,RE,RET> graph() { return type().graph(); }
    @Override public RV raw() { return this.vertex; }

    @Override public VT type() { return type; } 
  }
    ...
    TypedVertex.Type<V,VT,GoGraph<I,RV,RVT,RE,RET>,I,RV,RVT,RE,RET>
  {
    ...
    protected GoVertexType(RVT raw) { this.raw = raw; }
