...
> 
{
  ...
  @Override
  public GoTerm<I,RV,RVT,RE,RET> self() { return this; }

  // properties
  public String id() { return get( type().id ); }
  public String name() { return get( type().name ); }
  public String definition() { return get( type().definition ); }
  public String comment() { return get( type().comment ); }

  // rels
  public List<PartOf<I,RV,RVT,RE,RET>> partOf_in() { return inMany( graph().PartOf() ); }
  public List<GoTerm<I,RV,RVT,RE,RET>> partOf_inV() { return inManyV( graph().PartOf() ); }
